...
{
    public class MakinaAktiviteKayit : MyBindableBase
    {
        ...
        private int? süreDkGiris;
        private int zamanKutuWidth;
        ...
        public string MakinaKisaAd { get; set; }
        ...
        [NotMapped]
        public int? SüreDkGiris { get => süreDkGiris; set => SetProperty(ref süreDkGiris, value); }
        ...
        [NotMapped]
        public int ZamanKutuWidth { get => zamanKutuWidth; set => SetProperty(ref zamanKutuWidth , value); }
        ...
        public DateTime? KayitEklenmeTarihi { get; set; }
